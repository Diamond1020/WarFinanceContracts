...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x5AC71BAd7DCc7A94EFb4704b21A85B58FaCb5633), // GunGenesisRewardPool
        address(0x2B1B0231ea607B59357c46fB5369A260FA1eAC94) // GunRewardPool
    ];
    ...
    function initialize(
        ...
        bootstrapEpochs = 28;
        bootstrapSupplyExpansionPercent = 250; //2.5% to account for gun reward emissions during this time
